...
const { validateCreatePurchase, validateUpdatePurchase, validateChangeStatePurchase, validatePurchaseId } = require('../../middlewares/purchase/PurchaseValidations');
...
router.patch('/state/:id', validateChangeStatePurchase, purchaseController.changeStatePurchase);
