...
const createProjectValidation = [
  ...
  body('estado')
    ...
    .withMessage('El estado debe ser uno de: Pendiente, En Progreso, Completado, Cancelado'),
  ...
  body('materiales.*.precio_unitario')
    .if(body('materiales').exists())
    .notEmpty()
    .withMessage('El precio unitario es obligatorio para cada material')
    .isFloat({ min: 0 })
  ...
  body('servicios.*.precio_unitario')
    .if(body('servicios').exists())
    .notEmpty()
    .withMessage('El precio unitario es obligatorio para cada servicio')
    .isFloat({ min: 0 })
    .withMessage('El precio unitario debe ser un número positivo'),
  ...
  body('sedes.*.materialesAsignados.*.id_producto')
    ...
    .notEmpty()
    .withMessage('El ID del producto es obligatorio para cada material asignado')
    .isInt()
    .withMessage('El ID del producto debe ser un número entero'),
  ...
  body('sedes.*.serviciosAsignados.*.id_servicio')
    ...
    .notEmpty()
    .withMessage('El ID del servicio es obligatorio para cada servicio asignado')
    .isInt()
    .withMessage('El ID del servicio debe ser un número entero'),
  ...
  body('sedes.*.serviciosAsignados.*.precio_unitario')
    .if(body('sedes.*.serviciosAsignados').exists())
    .notEmpty()
    .withMessage('El precio unitario es obligatorio para cada servicio asignado')
    .isFloat({ min: 0 })
    .withMessage('El precio unitario debe ser un número positivo')
];
