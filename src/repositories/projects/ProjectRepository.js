      ...
      const project = await Project.create(
        {
          ...
          progreso: Number.isFinite(Number(projectData.progreso)) ? Number(projectData.progreso) : 0,
          prioridad: projectData.prioridad,
          ubicacion: projectData.ubicacion,
          descripcion: projectData.descripcion,
          observaciones: projectData.observaciones,
          costo_mano_obra: Number.isFinite(Number(projectData.costo_mano_obra)) ? Number(projectData.costo_mano_obra) : 0,
          costo_total_materiales: Number.isFinite(Number(projectData.costo_total_materiales)) ? Number(projectData.costo_total_materiales) : 0,
          costo_total_servicios: Number.isFinite(Number(projectData.costo_total_servicios)) ? Number(projectData.costo_total_servicios) : 0,
          costo_total_proyecto: Number.isFinite(Number(projectData.costo_total_proyecto)) ? Number(projectData.costo_total_proyecto) : 0,
        },
        { transaction }
      );
