...
<<<<<<< HEAD
    ...
    export interface Schema$EnrollmentToken {
         ...
         */
        googleAuthenticationOptions?: Schema$EnrollmentTokenGoogleAuthenticationOptions;
        /**
     ...
     */
    export interface Schema$EnrollmentTokenGoogleAuthenticationOptions {
        /**
...
=======
        createEnrollmentToken(params: Params$Resource$Enterprises$Createenrollmenttoken, options: StreamMethodOptions): GaxiosPromise<Readable>;
        createEnrollmentToken(params?: Params$Resource$Enterprises$Createenrollmenttoken, options?: MethodOptions): GaxiosPromise<Schema$CreateEnrollmentTokenResponse>;
        createEnrollmentToken(params: Params$Resource$Enterprises$Createenrollmenttoken, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createEnrollmentToken(params: Params$Resource$Enterprises$Createenrollmenttoken, options: MethodOptions | BodyResponseCallback<Schema$CreateEnrollmentTokenResponse>, callback: BodyResponseCallback<Schema$CreateEnrollmentTokenResponse>): void;
        createEnrollmentToken(params: Params$Resource$Enterprises$Createenrollmenttoken, callback: BodyResponseCallback<Schema$CreateEnrollmentTokenResponse>): void;
        createEnrollmentToken(callback: BodyResponseCallback<Schema$CreateEnrollmentTokenResponse>): void;
        /**
         * Returns a unique token to access an embeddable UI. To generate a web UI, pass the generated token into the managed Google Play javascript API. Each token may only be used to start one UI session. See the javascript API documentation for further information.
         *
         * @param params - Parameters for request
...
<<<<<<< HEAD
=======
    export interface Params$Resource$Enterprises$Createenrollmenttoken extends StandardParameters {
        /**
