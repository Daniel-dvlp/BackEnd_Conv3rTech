...
=======
        getBusinesscallssettings(params: Params$Resource$Locations$Getbusinesscallssettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getBusinesscallssettings(params?: Params$Resource$Locations$Getbusinesscallssettings, options?: MethodOptions): GaxiosPromise<Schema$BusinessCallsSettings>;
>>>>>>> dev
...
=======
        updateBusinesscallssettings(params: Params$Resource$Locations$Updatebusinesscallssettings, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateBusinesscallssettings(params?: Params$Resource$Locations$Updatebusinesscallssettings, options?: MethodOptions): GaxiosPromise<Schema$BusinessCallsSettings>;
>>>>>>> dev
...
=======
        list(params: Params$Resource$Locations$Businesscallsinsights$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Locations$Businesscallsinsights$List, options?: MethodOptions): GaxiosPromise<Schema$ListBusinessCallsInsightsResponse>;
>>>>>>> dev
