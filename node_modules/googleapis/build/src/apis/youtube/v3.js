...
<<<<<<< HEAD
    class Resource$Videotrainability {
        context;
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/youtube/v3/videoTrainability').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    youtube_v3.Resource$Videotrainability = Resource$Videotrainability;
...
<<<<<<< HEAD
    class Resource$Youtube$V3$Livechat {
        context;
        messages;
        constructor(context) {
            this.context = context;
    ...
    youtube_v3.Resource$Youtube$V3$Livechat = Resource$Youtube$V3$Livechat;
    class Resource$Youtube$V3$Livechat$Messages {
        context;
        constructor(context) {
            this.context = context;
        }
        stream(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/youtube/v3/liveChat/messages/stream').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    youtube_v3.Resource$Youtube$V3$Livechat$Messages = Resource$Youtube$V3$Livechat$Messages;
=======
>>>>>>> dev
