...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Locations$Clusters$Completecontrolplaneupgrade, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        completeControlPlaneUpgrade(params?: Params$Resource$Projects$Locations$Clusters$Completecontrolplaneupgrade, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Locations$Clusters$Completecontrolplaneupgrade, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Locations$Clusters$Completecontrolplaneupgrade, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Locations$Clusters$Completecontrolplaneupgrade, callback: BodyResponseCallback<Schema$Operation>): void;
        completeControlPlaneUpgrade(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Zones$Clusters$Completecontrolplaneupgrade, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        completeControlPlaneUpgrade(params?: Params$Resource$Projects$Zones$Clusters$Completecontrolplaneupgrade, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Zones$Clusters$Completecontrolplaneupgrade, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Zones$Clusters$Completecontrolplaneupgrade, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        completeControlPlaneUpgrade(params: Params$Resource$Projects$Zones$Clusters$Completecontrolplaneupgrade, callback: BodyResponseCallback<Schema$Operation>): void;
        completeControlPlaneUpgrade(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         * Completes master IP rotation.
         * @example
