...
=======
        logImpressions(params: Params$Resource$V3$Logimpressions, options: StreamMethodOptions): GaxiosPromise<Readable>;
        logImpressions(params?: Params$Resource$V3$Logimpressions, options?: MethodOptions): GaxiosPromise<Schema$GoogleMapsPlayablelocationsV3LogImpressionsResponse>;
>>>>>>> dev
...
=======
        logPlayerReports(params: Params$Resource$V3$Logplayerreports, options: StreamMethodOptions): GaxiosPromise<Readable>;
        logPlayerReports(params?: Params$Resource$V3$Logplayerreports, options?: MethodOptions): GaxiosPromise<Schema$GoogleMapsPlayablelocationsV3LogPlayerReportsResponse>;
>>>>>>> dev
...
=======
        samplePlayableLocations(params: Params$Resource$V3$Sampleplayablelocations, options: StreamMethodOptions): GaxiosPromise<Readable>;
        samplePlayableLocations(params?: Params$Resource$V3$Sampleplayablelocations, options?: MethodOptions): GaxiosPromise<Schema$GoogleMapsPlayablelocationsV3SamplePlayableLocationsResponse>;
>>>>>>> dev
