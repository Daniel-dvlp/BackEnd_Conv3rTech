...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countActiveDevices(params: Params$Resource$Customers$Reports$Countactivedevices, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countActiveDevices(params?: Params$Resource$Customers$Reports$Countactivedevices, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountActiveDevicesResponse>>;
        countActiveDevices(params: Params$Resource$Customers$Reports$Countactivedevices, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        countActiveDevices(params: Params$Resource$Customers$Reports$Countactivedevices, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1CountActiveDevicesResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountActiveDevicesResponse>): void;
        countActiveDevices(params: Params$Resource$Customers$Reports$Countactivedevices, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountActiveDevicesResponse>): void;
        countActiveDevices(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountActiveDevicesResponse>): void;
        /**
...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countDevicesPerBootType(params: Params$Resource$Customers$Reports$Countdevicesperboottype, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countDevicesPerBootType(params?: Params$Resource$Customers$Reports$Countdevicesperboottype, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountDevicesPerBootTypeResponse>>;
        countDevicesPerBootType(params: Params$Resource$Customers$Reports$Countdevicesperboottype, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        countDevicesPerBootType(params: Params$Resource$Customers$Reports$Countdevicesperboottype, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerBootTypeResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerBootTypeResponse>): void;
        countDevicesPerBootType(params: Params$Resource$Customers$Reports$Countdevicesperboottype, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerBootTypeResponse>): void;
        countDevicesPerBootType(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerBootTypeResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countDevicesPerReleaseChannel(params: Params$Resource$Customers$Reports$Countdevicesperreleasechannel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countDevicesPerReleaseChannel(params?: Params$Resource$Customers$Reports$Countdevicesperreleasechannel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountDevicesPerReleaseChannelResponse>>;
        countDevicesPerReleaseChannel(params: Params$Resource$Customers$Reports$Countdevicesperreleasechannel, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        countDevicesPerReleaseChannel(params: Params$Resource$Customers$Reports$Countdevicesperreleasechannel, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerReleaseChannelResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerReleaseChannelResponse>): void;
        countDevicesPerReleaseChannel(params: Params$Resource$Customers$Reports$Countdevicesperreleasechannel, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerReleaseChannelResponse>): void;
        countDevicesPerReleaseChannel(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountDevicesPerReleaseChannelResponse>): void;
        /**
