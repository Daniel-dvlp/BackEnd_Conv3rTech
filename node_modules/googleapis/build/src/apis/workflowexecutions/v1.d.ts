...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        triggerPubsubExecution(params: Params$Resource$Projects$Locations$Workflows$Triggerpubsubexecution, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        triggerPubsubExecution(params?: Params$Resource$Projects$Locations$Workflows$Triggerpubsubexecution, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Execution>>;
=======
...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteExecutionHistory(params: Params$Resource$Projects$Locations$Workflows$Executions$Deleteexecutionhistory, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        deleteExecutionHistory(params?: Params$Resource$Projects$Locations$Workflows$Executions$Deleteexecutionhistory, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        exportData(params: Params$Resource$Projects$Locations$Workflows$Executions$Exportdata, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        exportData(params?: Params$Resource$Projects$Locations$Workflows$Executions$Exportdata, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExportDataResponse>>;
...
<<<<<<< HEAD
    export class Resource$Projects$Locations$Workflows$Executions$Callbacks {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Workflows$Executions$Callbacks$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Workflows$Executions$Callbacks$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListCallbacksResponse>>;
    ...
    export class Resource$Projects$Locations$Workflows$Executions$Stepentries {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Workflows$Executions$Stepentries$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Workflows$Executions$Stepentries$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$StepEntry>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Workflows$Executions$Stepentries$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Workflows$Executions$Stepentries$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListStepEntriesResponse>>;
