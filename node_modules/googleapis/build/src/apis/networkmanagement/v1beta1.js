...
<<<<<<< HEAD
    ...
    networkmanagement_v1beta1.Resource$Organizations$Locations$Vpcflowlogsconfigs = Resource$Organizations$Locations$Vpcflowlogsconfigs;
    ...
    class Resource$Projects$Locations$Vpcflowlogsconfigs {
        ...
        queryOrgVpcFlowLogsConfigs(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v1beta1/{+parent}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
        ...
        showEffectiveFlowLogsConfigs(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v1beta1/{+parent}/vpcFlowLogsConfigs:showEffectiveFlowLogsConfigs').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
