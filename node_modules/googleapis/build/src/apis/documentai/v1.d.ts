...
<<<<<<< HEAD
    export class Resource$Projects$Locations$Schemas {
        ...
        create(params?: Params$Resource$Projects$Locations$Schemas$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1NextSchema>>;
        ...
        create(params: Params$Resource$Projects$Locations$Schemas$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        create(params: Params$Resource$Projects$Locations$Schemas$Create, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        /**
         * Deletes a schema.
         * @example
         * ```js
        ...
        get(params?: Params$Resource$Projects$Locations$Schemas$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1NextSchema>>;
        ...
        get(params: Params$Resource$Projects$Locations$Schemas$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        get(params: Params$Resource$Projects$Locations$Schemas$Get, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        /**
         * Lists Schemas.
         * @example
         * ```js
        ...
        list(params?: Params$Resource$Projects$Locations$Schemas$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1ListSchemasResponse>>;
        ...
        list(params: Params$Resource$Projects$Locations$Schemas$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemasResponse>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemasResponse>): void;
        list(params: Params$Resource$Projects$Locations$Schemas$List, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemasResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemasResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Locations$Schemas$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1NextSchema>>;
        ...
        patch(params: Params$Resource$Projects$Locations$Schemas$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        patch(params: Params$Resource$Projects$Locations$Schemas$Patch, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1NextSchema>): void;
    }
    ...
    export class Resource$Projects$Locations$Schemas$Schemaversions {
        ...
        create(params?: Params$Resource$Projects$Locations$Schemas$Schemaversions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1SchemaVersion>>;
        ...
        create(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        create(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Create, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        /**
        ...
        generate(params?: Params$Resource$Projects$Locations$Schemas$Schemaversions$Generate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1GenerateSchemaVersionResponse>>;
        ...
        generate(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Generate, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1GenerateSchemaVersionResponse>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1GenerateSchemaVersionResponse>): void;
        generate(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Generate, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1GenerateSchemaVersionResponse>): void;
        generate(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1GenerateSchemaVersionResponse>): void;
        /**
        ...
        get(params?: Params$Resource$Projects$Locations$Schemas$Schemaversions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1SchemaVersion>>;
        ...
        get(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        get(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Get, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Locations$Schemas$Schemaversions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1ListSchemaVersionsResponse>>;
        ...
        list(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemaVersionsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemaVersionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$List, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemaVersionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1ListSchemaVersionsResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Locations$Schemas$Schemaversions$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudDocumentaiV1SchemaVersion>>;
        ...
        patch(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        patch(params: Params$Resource$Projects$Locations$Schemas$Schemaversions$Patch, callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudDocumentaiV1SchemaVersion>): void;
    }
