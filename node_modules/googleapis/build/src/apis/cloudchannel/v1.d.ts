...
=======
        queryEligibleBillingAccounts(params: Params$Resource$Accounts$Customers$Queryeligiblebillingaccounts, options: StreamMethodOptions): GaxiosPromise<Readable>;
        queryEligibleBillingAccounts(params?: Params$Resource$Accounts$Customers$Queryeligiblebillingaccounts, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1QueryEligibleBillingAccountsResponse>;
>>>>>>> dev
...
=======
        listEntitlementChanges(params: Params$Resource$Accounts$Customers$Entitlements$Listentitlementchanges, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listEntitlementChanges(params?: Params$Resource$Accounts$Customers$Entitlements$Listentitlementchanges, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1ListEntitlementChangesResponse>;
>>>>>>> dev
...
=======
        list(params: Params$Resource$Accounts$Skugroups$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Accounts$Skugroups$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1ListSkuGroupsResponse>;
>>>>>>> dev
...
=======
        list(params: Params$Resource$Accounts$Skugroups$Billableskus$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Accounts$Skugroups$Billableskus$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1ListSkuGroupBillableSkusResponse>;
>>>>>>> dev
