...
>>>>>>> dev
            this.merchantCenterAccountLinks =
                new Resource$Projects$Locations$Catalogs$Merchantcenteraccountlinks(this.context);
...
<<<<<<< HEAD
        ...
        getConversationalSearchCustomizationConfig(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v2alpha/{+name}/conversationalSearchCustomizationConfig').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
=======
>>>>>>> dev
...
<<<<<<< HEAD
        updateConversationalSearchCustomizationConfig(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v2alpha/{+catalog}/conversationalSearchCustomizationConfig').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'PATCH',
                    apiVersion: '',
                }, options),
                params,
