...
<<<<<<< HEAD
    class Resource$Projects$Locations$Reservationgroups {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/reservationGroups').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    bigqueryreservation_v1.Resource$Projects$Locations$Reservationgroups = Resource$Projects$Locations$Reservationgroups;
