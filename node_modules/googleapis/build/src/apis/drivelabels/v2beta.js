...
<<<<<<< HEAD
        ...
        updateLabelEnabledAppSettings(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2beta/{+name}:updateLabelEnabledAppSettings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
=======
>>>>>>> dev
...
})(drivelabels_v2beta || (exports.drivelabels_v2beta = drivelabels_v2beta = {}));
