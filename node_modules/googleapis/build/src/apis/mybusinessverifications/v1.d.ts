...
<<<<<<< HEAD
     ...
     */
    export interface Schema$GenerateInstantVerificationTokenResponse {
        /**
         * The generated instant verification token.
         */
        instantVerificationToken?: string | null;
        /**
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        fetchVerificationOptions(params: Params$Resource$Locations$Fetchverificationoptions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchVerificationOptions(params?: Params$Resource$Locations$Fetchverificationoptions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchVerificationOptionsResponse>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        getVoiceOfMerchantState(params: Params$Resource$Locations$Getvoiceofmerchantstate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getVoiceOfMerchantState(params?: Params$Resource$Locations$Getvoiceofmerchantstate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$VoiceOfMerchantState>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        verify(params: Params$Resource$Locations$Verify, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        verify(params?: Params$Resource$Locations$Verify, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$VerifyLocationResponse>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        complete(params: Params$Resource$Locations$Verifications$Complete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        complete(params?: Params$Resource$Locations$Verifications$Complete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CompleteVerificationResponse>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        list(params: Params$Resource$Locations$Verifications$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Locations$Verifications$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListVerificationsResponse>>;
=======
...
<<<<<<< HEAD
         ...
         *   // Example response
         *   // {
         *   //   "instantVerificationToken": "my_instantVerificationToken",
         *   //   "result": "my_result"
         *   // }
         * }
         *
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        generate(params: Params$Resource$Verificationtokens$Generate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generate(params?: Params$Resource$Verificationtokens$Generate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateInstantVerificationTokenResponse>>;
        ...
        generate(params: Params$Resource$Verificationtokens$Generate, options: MethodOptions | BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>, callback: BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>): void;
        generate(params: Params$Resource$Verificationtokens$Generate, callback: BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>): void;
        generate(callback: BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>): void;
=======
...
>>>>>>> dev
    ...
    export interface Params$Resource$Verificationtokens$Generate extends StandardParameters {
         ...
         */
<<<<<<< HEAD
        requestBody?: Schema$GenerateInstantVerificationTokenRequest;
=======
