...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        list(params: Params$Resource$Organizations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Organizations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListOrganizationsResponse>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        update(params: Params$Resource$Organizations$Update, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        update(params?: Params$Resource$Organizations$Update, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Organization>>;
=======
