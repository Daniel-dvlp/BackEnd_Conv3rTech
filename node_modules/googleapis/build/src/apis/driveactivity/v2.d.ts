...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        query(params: Params$Resource$Activity$Query, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        query(params?: Params$Resource$Activity$Query, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$QueryDriveActivityResponse>>;
=======
