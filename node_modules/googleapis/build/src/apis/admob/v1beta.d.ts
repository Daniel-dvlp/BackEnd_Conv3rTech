...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        list(params: Params$Resource$Accounts$Adsources$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Accounts$Adsources$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAdSourcesResponse>>;
=======
        list(params: Params$Resource$Accounts$Adsources$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Accounts$Adsources$List, options?: MethodOptions): GaxiosPromise<Schema$ListAdSourcesResponse>;
>>>>>>> dev
        list(params: Params$Resource$Accounts$Adsources$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Accounts$Adsources$List, options: MethodOptions | BodyResponseCallback<Schema$ListAdSourcesResponse>, callback: BodyResponseCallback<Schema$ListAdSourcesResponse>): void;
        list(params: Params$Resource$Accounts$Adsources$List, callback: BodyResponseCallback<Schema$ListAdSourcesResponse>): void;
...
<<<<<<< HEAD
    export class Resource$Accounts$Adsources$Adapters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Accounts$Adsources$Adapters$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Accounts$Adsources$Adapters$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAdaptersResponse>>;
        list(params: Params$Resource$Accounts$Adsources$Adapters$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Accounts$Adsources$Adapters$List, options: MethodOptions | BodyResponseCallback<Schema$ListAdaptersResponse>, callback: BodyResponseCallback<Schema$ListAdaptersResponse>): void;
        list(params: Params$Resource$Accounts$Adsources$Adapters$List, callback: BodyResponseCallback<Schema$ListAdaptersResponse>): void;
    ...
    export class Resource$Accounts$Adunitmappings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchCreate(params: Params$Resource$Accounts$Adunitmappings$Batchcreate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchCreate(params?: Params$Resource$Accounts$Adunitmappings$Batchcreate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchCreateAdUnitMappingsResponse>>;
        batchCreate(params: Params$Resource$Accounts$Adunitmappings$Batchcreate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchCreate(params: Params$Resource$Accounts$Adunitmappings$Batchcreate, options: MethodOptions | BodyResponseCallback<Schema$BatchCreateAdUnitMappingsResponse>, callback: BodyResponseCallback<Schema$BatchCreateAdUnitMappingsResponse>): void;
        batchCreate(params: Params$Resource$Accounts$Adunitmappings$Batchcreate, callback: BodyResponseCallback<Schema$BatchCreateAdUnitMappingsResponse>): void;
        batchCreate(callback: BodyResponseCallback<Schema$BatchCreateAdUnitMappingsResponse>): void;
    }
    ...
    export class Resource$Accounts$Adunits {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Accounts$Adunits$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Accounts$Adunits$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AdUnit>>;
        create(params: Params$Resource$Accounts$Adunits$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Accounts$Adunits$Create, options: MethodOptions | BodyResponseCallback<Schema$AdUnit>, callback: BodyResponseCallback<Schema$AdUnit>): void;
        create(params: Params$Resource$Accounts$Adunits$Create, callback: BodyResponseCallback<Schema$AdUnit>): void;
...
<<<<<<< HEAD
    export class Resource$Accounts$Adunits$Adunitmappings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Accounts$Adunits$Adunitmappings$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Accounts$Adunits$Adunitmappings$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AdUnitMapping>>;
        create(params: Params$Resource$Accounts$Adunits$Adunitmappings$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Accounts$Adunits$Adunitmappings$Create, options: MethodOptions | BodyResponseCallback<Schema$AdUnitMapping>, callback: BodyResponseCallback<Schema$AdUnitMapping>): void;
        create(params: Params$Resource$Accounts$Adunits$Adunitmappings$Create, callback: BodyResponseCallback<Schema$AdUnitMapping>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Accounts$Adunits$Adunitmappings$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Accounts$Adunits$Adunitmappings$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAdUnitMappingsResponse>>;
        list(params: Params$Resource$Accounts$Adunits$Adunitmappings$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Accounts$Adunits$Adunitmappings$List, options: MethodOptions | BodyResponseCallback<Schema$ListAdUnitMappingsResponse>, callback: BodyResponseCallback<Schema$ListAdUnitMappingsResponse>): void;
        list(params: Params$Resource$Accounts$Adunits$Adunitmappings$List, callback: BodyResponseCallback<Schema$ListAdUnitMappingsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAdUnitMappingsResponse>): void;
    }
...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Accounts$Apps$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Accounts$Apps$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$App>>;
        create(params: Params$Resource$Accounts$Apps$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Accounts$Apps$Create, options: MethodOptions | BodyResponseCallback<Schema$App>, callback: BodyResponseCallback<Schema$App>): void;
        create(params: Params$Resource$Accounts$Apps$Create, callback: BodyResponseCallback<Schema$App>): void;
...
<<<<<<< HEAD
    export class Resource$Accounts$Campaignreport {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generate(params: Params$Resource$Accounts$Campaignreport$Generate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generate(params?: Params$Resource$Accounts$Campaignreport$Generate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateCampaignReportResponse>>;
        generate(params: Params$Resource$Accounts$Campaignreport$Generate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generate(params: Params$Resource$Accounts$Campaignreport$Generate, options: MethodOptions | BodyResponseCallback<Schema$GenerateCampaignReportResponse>, callback: BodyResponseCallback<Schema$GenerateCampaignReportResponse>): void;
        generate(params: Params$Resource$Accounts$Campaignreport$Generate, callback: BodyResponseCallback<Schema$GenerateCampaignReportResponse>): void;
        generate(callback: BodyResponseCallback<Schema$GenerateCampaignReportResponse>): void;
    }
    ...
    export class Resource$Accounts$Mediationgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Accounts$Mediationgroups$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Accounts$Mediationgroups$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MediationGroup>>;
        create(params: Params$Resource$Accounts$Mediationgroups$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Accounts$Mediationgroups$Create, options: MethodOptions | BodyResponseCallback<Schema$MediationGroup>, callback: BodyResponseCallback<Schema$MediationGroup>): void;
        create(params: Params$Resource$Accounts$Mediationgroups$Create, callback: BodyResponseCallback<Schema$MediationGroup>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Accounts$Mediationgroups$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Accounts$Mediationgroups$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListMediationGroupsResponse>>;
        list(params: Params$Resource$Accounts$Mediationgroups$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Accounts$Mediationgroups$List, options: MethodOptions | BodyResponseCallback<Schema$ListMediationGroupsResponse>, callback: BodyResponseCallback<Schema$ListMediationGroupsResponse>): void;
        list(params: Params$Resource$Accounts$Mediationgroups$List, callback: BodyResponseCallback<Schema$ListMediationGroupsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListMediationGroupsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Accounts$Mediationgroups$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Accounts$Mediationgroups$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MediationGroup>>;
        patch(params: Params$Resource$Accounts$Mediationgroups$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Accounts$Mediationgroups$Patch, options: MethodOptions | BodyResponseCallback<Schema$MediationGroup>, callback: BodyResponseCallback<Schema$MediationGroup>): void;
        patch(params: Params$Resource$Accounts$Mediationgroups$Patch, callback: BodyResponseCallback<Schema$MediationGroup>): void;
    ...
    export class Resource$Accounts$Mediationgroups$Mediationabexperiments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MediationAbExperiment>>;
        create(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Create, options: MethodOptions | BodyResponseCallback<Schema$MediationAbExperiment>, callback: BodyResponseCallback<Schema$MediationAbExperiment>): void;
        create(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Create, callback: BodyResponseCallback<Schema$MediationAbExperiment>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        stop(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Stop, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        stop(params?: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Stop, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MediationAbExperiment>>;
        stop(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Stop, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        stop(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Stop, options: MethodOptions | BodyResponseCallback<Schema$MediationAbExperiment>, callback: BodyResponseCallback<Schema$MediationAbExperiment>): void;
        stop(params: Params$Resource$Accounts$Mediationgroups$Mediationabexperiments$Stop, callback: BodyResponseCallback<Schema$MediationAbExperiment>): void;
