...
<<<<<<< HEAD
         ...
         *     // A path to a file in Google Cloud Storage. Example: gs://build-app-1414623860166/app%40debug-unaligned.apk These paths are expected to be url encoded (percent encoding)
         *     'bundleLocation.gcsPath': 'placeholder-value',
         *
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        getApkDetails(params: Params$Resource$Applicationdetailservice$Getapkdetails, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getApkDetails(params?: Params$Resource$Applicationdetailservice$Getapkdetails, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetApkDetailsResponse>>;
=======
...
<<<<<<< HEAD
    ...
    export class Resource$Projects$Devicesessions {
         ...
         *
         *   // Do the magic
         *   const res = await testing.projects.deviceSessions.cancel({
         *     // Required. Name of the DeviceSession, e.g. "projects/{project_id\}/deviceSessions/{session_id\}"
         *     name: 'projects/my-project/deviceSessions/my-deviceSession',
         *
         *     // Request body metadata
         *     requestBody: {
         *       // request body parameters
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancel(params: Params$Resource$Projects$Devicesessions$Cancel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        cancel(params?: Params$Resource$Projects$Devicesessions$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
         ...
         *
         *   // Do the magic
         *   const res = await testing.projects.deviceSessions.create({
         ...
         *       // request body parameters
         *       // {
         *       //   "activeStartTime": "my_activeStartTime",
         *       //   "androidDevice": {},
         *       //   "createTime": "my_createTime",
         *       //   "displayName": "my_displayName",
         *       //   "expireTime": "my_expireTime",
         *       //   "inactivityTimeout": "my_inactivityTimeout",
         *       //   "name": "my_name",
         *       //   "state": "my_state",
         *       //   "stateHistories": [],
         *       //   "ttl": "my_ttl"
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Devicesessions$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Devicesessions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeviceSession>>;
         ...
         *
         *   // Do the magic
         *   const res = await testing.projects.deviceSessions.get({
         *     // Required. Name of the DeviceSession, e.g. "projects/{project_id\}/deviceSessions/{session_id\}"
         *     name: 'projects/my-project/deviceSessions/my-deviceSession',
         *   });
         *   console.log(res.data);
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Devicesessions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Devicesessions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeviceSession>>;
         ...
         *
         *   // Do the magic
         *   const res = await testing.projects.deviceSessions.list({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Devicesessions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Devicesessions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListDeviceSessionsResponse>>;
         ...
         *
         *   // Do the magic
         *   const res = await testing.projects.deviceSessions.patch({
         *     // Optional. Name of the DeviceSession, e.g. "projects/{project_id\}/deviceSessions/{session_id\}"
         *     name: 'projects/my-project/deviceSessions/my-deviceSession',
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Devicesessions$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Devicesessions$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeviceSession>>;
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        cancel(params: Params$Resource$Projects$Testmatrices$Cancel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        cancel(params?: Params$Resource$Projects$Testmatrices$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CancelTestMatrixResponse>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        create(params: Params$Resource$Projects$Testmatrices$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Testmatrices$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestMatrix>>;
=======
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        get(params: Params$Resource$Projects$Testmatrices$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Testmatrices$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestMatrix>>;
=======
...
<<<<<<< HEAD
         ...
         *     includeViewableModels: 'placeholder-value',
...
>>>>>>> dev
         ...
         */
<<<<<<< HEAD
        get(params: Params$Resource$Testenvironmentcatalog$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Testenvironmentcatalog$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestEnvironmentCatalog>>;
=======
