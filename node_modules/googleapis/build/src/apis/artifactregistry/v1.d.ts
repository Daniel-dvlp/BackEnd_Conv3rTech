...
<<<<<<< HEAD
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        exportArtifact(params: Params$Resource$Projects$Locations$Repositories$Exportartifact, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        exportArtifact(params?: Params$Resource$Projects$Locations$Repositories$Exportartifact, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        exportArtifact(params: Params$Resource$Projects$Locations$Repositories$Exportartifact, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        exportArtifact(params: Params$Resource$Projects$Locations$Repositories$Exportartifact, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        exportArtifact(params: Params$Resource$Projects$Locations$Repositories$Exportartifact, callback: BodyResponseCallback<Schema$Operation>): void;
...
<<<<<<< HEAD
    export interface Params$Resource$Projects$Locations$Repositories$Exportartifact extends StandardParameters {
        /**
         * Required. The repository of the artifact to export. Format: projects/{project\}/locations/{location\}/repositories/{repository\}
         */
        repository?: string;
