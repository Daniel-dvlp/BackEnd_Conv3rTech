...
=======
        delete(params: Params$Resource$Accounts$Languages$Productcertifications$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Accounts$Languages$Productcertifications$Delete, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
>>>>>>> dev
...
=======
        get(params: Params$Resource$Accounts$Languages$Productcertifications$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Accounts$Languages$Productcertifications$Get, options?: MethodOptions): GaxiosPromise<Schema$ProductCertification>;
>>>>>>> dev
...
=======
        list(params: Params$Resource$Accounts$Languages$Productcertifications$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Accounts$Languages$Productcertifications$List, options?: MethodOptions): GaxiosPromise<Schema$ListProductCertificationsResponse>;
>>>>>>> dev
...
=======
        patch(params: Params$Resource$Accounts$Languages$Productcertifications$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Accounts$Languages$Productcertifications$Patch, options?: MethodOptions): GaxiosPromise<Schema$ProductCertification>;
>>>>>>> dev
