...
<<<<<<< HEAD
         ...
         *
         *   // Do the magic
         *   const res = await cloudscheduler.projects.locations.getCmekConfig({
...
<<<<<<< HEAD
         ...
         *
         *   // Do the magic
         *   const res = await cloudscheduler.projects.locations.updateCmekConfig({
         *     // Identifier. The config resource name which includes the project and location and must end in 'cmekConfig', in the format projects/PROJECT_ID/locations/LOCATION_ID/cmekConfig`
         *     name: 'projects/my-project/locations/my-location/cmekConfig',
        ...
        updateCmekConfig(params?: Params$Resource$Projects$Locations$Updatecmekconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        updateCmekConfig(params: Params$Resource$Projects$Locations$Updatecmekconfig, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        updateCmekConfig(params: Params$Resource$Projects$Locations$Updatecmekconfig, callback: BodyResponseCallback<Schema$Operation>): void;
        updateCmekConfig(callback: BodyResponseCallback<Schema$Operation>): void;
=======
>>>>>>> dev
    }
