...
<<<<<<< HEAD
    ...
    class Resource$Projects$Locations$Generators$Evaluations {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2beta1/{+parent}/evaluations').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    dialogflow_v2beta1.Resource$Projects$Locations$Generators$Evaluations = Resource$Projects$Locations$Generators$Evaluations;
...
<<<<<<< HEAD
    class Resource$Projects$Locations$Tools {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2beta1/{+parent}/tools').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    dialogflow_v2beta1.Resource$Projects$Locations$Tools = Resource$Projects$Locations$Tools;
