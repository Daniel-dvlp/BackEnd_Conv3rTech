...
<<<<<<< HEAD
            ...
            this.tools = new Resource$Projects$Locations$Tools(this.context);
=======
            this.knowledgeBases = new Resource$Projects$Locations$Knowledgebases(this.context);
            this.operations = new Resource$Projects$Locations$Operations(this.context);
            this.suggestions = new Resource$Projects$Locations$Suggestions(this.context);
...
<<<<<<< HEAD
    ...
    class Resource$Projects$Locations$Generators {
        ...
        constructor(context) {
            this.context = context;
            this.evaluations = new Resource$Projects$Locations$Generators$Evaluations(this.context);
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
    ...
    class Resource$Projects$Locations$Generators$Evaluations {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    dialogflow_v2.Resource$Projects$Locations$Generators$Evaluations = Resource$Projects$Locations$Generators$Evaluations;
...
<<<<<<< HEAD
    class Resource$Projects$Locations$Siptrunks {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}/sipTrunks').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    dialogflow_v2.Resource$Projects$Locations$Siptrunks = Resource$Projects$Locations$Siptrunks;
...
<<<<<<< HEAD
    class Resource$Projects$Locations$Tools {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    dialogflow_v2.Resource$Projects$Locations$Tools = Resource$Projects$Locations$Tools;
