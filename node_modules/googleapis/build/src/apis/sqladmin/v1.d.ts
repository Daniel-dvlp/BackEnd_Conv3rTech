...
=======
        reencrypt(params: Params$Resource$Instances$Reencrypt, options: StreamMethodOptions): GaxiosPromise<Readable>;
        reencrypt(params?: Params$Resource$Instances$Reencrypt, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
>>>>>>> dev
...
=======
        getDiskShrinkConfig(params: Params$Resource$Projects$Instances$Getdiskshrinkconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getDiskShrinkConfig(params?: Params$Resource$Projects$Instances$Getdiskshrinkconfig, options?: MethodOptions): GaxiosPromise<Schema$SqlInstancesGetDiskShrinkConfigResponse>;
>>>>>>> dev
...
=======
        getLatestRecoveryTime(params: Params$Resource$Projects$Instances$Getlatestrecoverytime, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getLatestRecoveryTime(params?: Params$Resource$Projects$Instances$Getlatestrecoverytime, options?: MethodOptions): GaxiosPromise<Schema$SqlInstancesGetLatestRecoveryTimeResponse>;
>>>>>>> dev
...
=======
        performDiskShrink(params: Params$Resource$Projects$Instances$Performdiskshrink, options: StreamMethodOptions): GaxiosPromise<Readable>;
        performDiskShrink(params?: Params$Resource$Projects$Instances$Performdiskshrink, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
>>>>>>> dev
...
=======
        resetReplicaSize(params: Params$Resource$Projects$Instances$Resetreplicasize, options: StreamMethodOptions): GaxiosPromise<Readable>;
        resetReplicaSize(params?: Params$Resource$Projects$Instances$Resetreplicasize, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
>>>>>>> dev
